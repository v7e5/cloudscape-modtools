...
import {useCurrentMode} from '~/components/internal/toolkit/internal'
...
const InternalContentLayout = memo(
  ({
    children,
    disableOverlap,
    header,
    ...
    const contentHeaderClassName =
      headerVariant === 'high-contrast' && isVisualRefresh
        ...
        <div
          ...
          {headerBackgroundStyle && (
            <div
              ...
              style={{
                background:
                  typeof headerBackgroundStyle === 'function'
        ...
        {header && secondaryHeader && (
          <div
            ...
            <InternalGrid
              ...
              <div className={clsx(testutilStyles['secondary-header'])}>
                {secondaryHeader}
              </div>
            </InternalGrid>
          </div>
...
export {
  InternalContentLayout as default
}
