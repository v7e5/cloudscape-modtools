  ...
  forwardRef(
    (
      ...
      const filtersNode = (defaultFilter || additionalFilters) && (
        <InternalBox
          ...
          <InternalSpaceBetween
            ...
            className={clsx({
              [styles['has-default-filter']]: !!defaultFilter
            })}>
            {defaultFilter}
            {additionalFilters}
          </InternalSpaceBetween>
      ...
      const legendNode = legend && (
        <InternalBox margin={{top: 'm'}}>{legend}</InternalBox>
      )
      if (fitHeight) {
        return (
          <div
            ...
            className={clsx(
              baseProps.className,
              styles.wrapper,
              styles['wrapper--fit-height']
            )}
            onBlur={onBlur}>
            <div
              className={clsx(
                styles['inner-wrapper'],
                styles['inner-wrapper--fit-height']
              )}>
              {filtersNode}
              <div
      ...
      return (
        <div
          ref={ref}
          {...baseProps}
          className={clsx(baseProps.className, styles.wrapper)}
          onBlur={onBlur}>
          {filtersNode}
          <div
            className={clsx(styles.content, contentClassName, {
