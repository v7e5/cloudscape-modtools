...
const isVisible = (date, baseDate, isSingleGrid) => {
  if (isSingleGrid) {
...
const Grids = memo(
  ({
    ...
    const onGridKeyDownHandler = event => {
      ...
      const updatedDateIsVisible = isVisible(
        updatedFocusDate,
        baseDate,
        isSingleGrid
      )
