...
const formatValue = (value, {timeOffset, dateOnly}) => {
...
const getDefaultMode = (value, relativeOptions, rangeSelectorMode) => {
  if (value && value.type) {
    return value.type
  }
...
const splitAbsoluteValue = value => {
  if (!value) {
    return {
      start: {date: '', time: ''},
      end: {date: '', time: ''}
