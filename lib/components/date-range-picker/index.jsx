import {useRef, useState, Fragment, forwardRef, memo} from 'react'
...
const DateRangePicker = memo(
  forwardRef(
    (
      ...
      const normalizedTimeOffset = normalizeTimeOffset(
        value,
        getTimeOffset,
        timeOffset
      )
      ...
      const {invalid, warning, controlId, ariaDescribedby, ariaLabelledby} =
        useFormFieldContext({
          ariaLabelledby: rest.ariaLabelledby ?? i18nStrings?.ariaLabelledby,
          ariaDescribedby:
            rest.ariaDescribedby ?? i18nStrings?.ariaDescribedby,
          ...rest
        })
      ...
      const onApply = newValue => {
        ...
        fireNonCancelableEvent(onChange, {
          value: formatValue(newValue, {
            dateOnly,
            timeOffset: normalizeTimeOffset(
              newValue,
              getTimeOffset,
              timeOffset
            )
