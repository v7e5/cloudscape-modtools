...
const shadowsTokens = {
  shadowFlashSticky: import_shadows.tokens.shadowFlashSticky,
  shadowPanel: import_shadows.tokens.shadowPanel,
  shadowPanelToggle: import_shadows.tokens.shadowPanelToggle
};
const darkModeColorValues = (0, import_utils.pickState)(import_colors.tokens, "dark");
const darkModeShadowsValues = (0, import_utils.pickState)(import_shadows.tokens, "dark");
const expandedTokens = (0, import_utils.expandColorDictionary)(
  (0, import_merge.default)({}, darkModeShadowsValues, darkModeColorValues, shadowsTokens, colorTokens)
);
const mode = "color";
